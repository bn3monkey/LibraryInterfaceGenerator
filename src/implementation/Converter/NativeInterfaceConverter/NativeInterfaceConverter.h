#ifndef __BN3MONKEY_LIBRARYINTERFACEGENERATOR_NativeInterfaceConverter__
#define __BN3MONKEY_LIBRARYINTERFACEGENERATOR_NativeInterfaceConverter__
...
"}"
"";
#endif // __BN3MONKEY_LIBRARYINTERFACEGENERATOR_NativeInterfaceConverter__
